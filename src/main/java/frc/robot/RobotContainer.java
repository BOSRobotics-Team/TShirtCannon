...
private final XboxController xboxController = new XboxController(0);
  ...
  //Driver Controller
  public final JoystickButton a_Button_Driver = new JoystickButton(xboxController, XboxController.Button.kA.value);
  public final JoystickButton b_Button_Driver = new JoystickButton(xboxController, XboxController.Button.kB.value);
  public final JoystickButton x_Button_Driver = new JoystickButton(xboxController, XboxController.Button.kX.value);
  public final JoystickButton y_Button_Driver = new JoystickButton(xboxController, XboxController.Button.kY.value);
  public final JoystickButton left_Bumper_Driver = new JoystickButton(xboxController, XboxController.Button.kLeftBumper.value);
  public final JoystickButton right_Bumper_Driver = new JoystickButton(xboxController, XboxController.Button.kRightBumper.value);
  public final JoystickButton back_Button_Driver = new JoystickButton(xboxController, XboxController.Button.kBack.value);
  public final JoystickButton start_Button_Driver = new JoystickButton(xboxController, XboxController.Button.kStart.value);
  public final JoystickButton left_Stick_Driver = new JoystickButton(xboxController, XboxController.Button.kLeftStick.value);
  public final JoystickButton right_Stick_Driver = new JoystickButton(xboxController, XboxController.Button.kRightStick.value);
